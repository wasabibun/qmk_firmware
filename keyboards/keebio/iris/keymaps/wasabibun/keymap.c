...
[_LAYER0] = LAYOUT(KC_ESC, KC_1, KC_2, KC_3, KC_4, KC_5,                            KC_6, KC_7, KC_8, KC_9, KC_0, KC_DEL, 
                   ...
                   KC_LCTL, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_HOME,              KC_SPC, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_ENT,
                                        KC_LGUI, MO(2), TO(1),                   KC_SPC, MO(1), KC_RALT),
...
[_LAYER1] = LAYOUT(TD(TD_F1_RESET), KC_F2, KC_F3, KC_F4, KC_F5, KC_F6,              KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, KC_F12,
                   ...
                   KC_NO, KC_NO, KC_NO, KC_PSCR, KC_LPRN, KC_RPRN, KC_NO,       KC_SPC, KC_LCBR, KC_RCBR, KC_LBRC, KC_RBRC, KC_NO, KC_PENT,
                                                KC_NO, KC_NO, TO(2),             KC_SPC, KC_NO, KC_NO),
...
[_LAYER2] = LAYOUT(KC_GRV, KC_1, KC_2, KC_3, KC_4, KC_5,                            KC_6, KC_7, KC_8, KC_9, KC_0, KC_BSLS, 
                   ...
                   KC_LSFT, KC_MPRV, KC_MNXT, KC_NO, KC_VOLU, KC_UNDS,              KC_MINS, RGB_VAI, KC_NO, RGB_HUI, RGB_SAI, KC_NO, 
                   KC_MUTE, KC_MSTP, KC_MPLY, KC_NO, KC_VOLD, KC_EQL, KC_NO,    KC_SPC, KC_PLUS, RGB_VAD, KC_NO, RGB_HUD, RGB_SAD, KC_ENT,
                                                    KC_NO, KC_NO, TO(0),          KC_SPC, KC_NO, KC_NO) 
